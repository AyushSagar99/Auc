...
actor VickreyAuction {
  ...
  public shared(msg) func createAuction(
    ...
    // Don't allow anonymous principals to create auctions
    if (Principal.isAnonymous(caller)) {
      Debug.trap("Anonymous principals cannot create auctions");
    };
      ...
      case (?auction) {
        ...
        switch (bids.get(auctionId)) {
          ...
          case (?auctionBids) {
            ...
            let sortedBids = Array.sort<Bid>(auctionBids, func(a, b) {
